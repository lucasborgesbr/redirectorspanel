          ...
          <form method="post" action="functions/processa-registro.php">
            ...
            <div class="card card-novo" data-background="color" data-color="blue">
              <div class="card-header">
                ...
                </div><h3 class="card-title">Criar Uma Conta</h3><br>
              </div>
              ...
              <div class="card-content">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    <div class="form-group">
                      ...
                      <input type="text" id="cpf" name="cpf" class="form-control border-input MaskCPF" style="border:1px solid #ccc; background: #fff;" required>
                    </div>
                  </div>
                  <div class="col-lg-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>Senha</label>
                      <input type="password" name="senha" id="password" class="form-control senha" required  style="border:1px solid #ccc; background: #fff;">
                      <small id="senhaOBS"></small>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>Confirma Senha</label>
                      <input type="password" name="confirmasenha" id="password2" class="form-control confirma-senha" required style="border:1px solid #ccc; background: #fff;">
                      <small id="confirmaSenhaOBS"></small>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-3">
                    <h3 class="card-title">Endereço</h3><br>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control border-input MaskCEP" placeholder="Cep" name="cep" id="cep" onblur="buscaCEPMask();" disabled required>
              ...
              <div class="card-footer text-center">
                <br>
                <button type="submit" class="btn btn-fill btn-wd btnCriar">CRIAR</button><br><br>
                <div class="forgot">
...
<script type="text/javascript">
  ...
  $("#password").on("focusout", function () {
    if ($(this).val() != $("#password2").val()) {
      $('#confirmaSenhaOBS').html('Senhas Diferentes!');
      $('.btnCriar').prop('disabled', true);
    } else {
      $('#confirmaSenhaOBS').html('Senhas Conferem!');
