...
function armazenamento(){
    ...
    for(e=0;e<dias.length;e++){
            ...
            diastotal += (dias[e].value - 50)* qtde[e].value;
            // definir aqui a taxa diaria apos 50 dias, nesse caso 1$ por dia;
...
function valorservico(){
  var pesototal = $('#pesototal').val(); //document.getElementById('pesototal').value;
  var valorservico = $('#valorservico').val(); //document.getElementById('valorservico');

var valor = 20;
//var valor = '';
//if (pesototal <= 10) { valor = 20;}
//if (pesototal >= 10.1 && pesototal <= 30) {valor = 30;}
//if (pesototal >= 4537 && pesototal <= 13607) {valor= 30;}
//if (pesototal > 30) {valor = 40;}
...
function opcaoPgto(){
    ...
    if (oppgto == "Ebanx") {taxa = "3.00";}
    if (oppgto == "Itau") {taxa = "7.00";}
...
function servicosExtras(){
    ...
    var cinco = document.getElementById('5').checked;
        ...
        var doze = document.getElementById('12').checked;
        var treze = document.getElementById('13').checked;
        ...
        if(cinco){
		    if(t <= 15){valorse += 0;}
		    if(t >= 16 && t <= 25){valorse += 8;}
		    if(t >= 26 && t <= 40){valorse += 14;}
		    if(t >= 41 && t <= 60){valorse += 20;}
		    if(t >= 61){valorse += 25;}
		}
		
		if(seis){
		    if(qtdEmbalagem == 1){valorse += 10;}
		    if(qtdEmbalagem >= 2){valorse += 8 * qtdEmbalagem;}
		}
		
        if(sete){
            if(peso <= 20){valorse += 7;}
            if(peso >= 21 && peso <= 40){valorse += 10;}
            if(peso >= 41){valorse += 15;}
        }
        
        if(oito){
            if(peso <= 20){valorse += 8;}
            if(peso >= 21 && peso <= 40){valorse += 12;}
            if(peso >= 41){valorse += 17;}
        }
