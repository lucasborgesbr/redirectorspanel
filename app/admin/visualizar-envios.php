                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="content">
                                    <p>
                                        <?php if ($row_envios['formaenvio'] == "First_Class") {echo "USPS - First Class" ; } ?>
                                        <?php if ($row_envios['formaenvio'] == "Priority") {echo "USPS - Prority Mail" ; } ?>
                                        <?php if ($row_envios['formaenvio'] == "Express") {echo "USPS - Prority Mail Express" ; } ?>
